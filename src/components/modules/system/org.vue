  ...
  methods: {
    ...
    editOrg() {
      ...
      if (
        ...
        this.$refs.orgTable.selection.length == 0
      ) {
        this.$message({
          message: "请选择要修改的数据",
          type: "info"
      ...
      if (
        this.$refs.orgTable.selection &&
        this.$refs.orgTable.selection.length > 1
      ) {
        this.$message({
          message: "只能选择一条数据",
          type: "info"
      ...
      this.orgDialogFormData.orgName = this.$refs.orgTable.selection[0][
        "orgName"
      ];
